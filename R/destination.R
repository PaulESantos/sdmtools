...
#' given in WGS 84.
#'
#' Typical useages are:\cr
#' \enumerate{ \item a single start location, bearing and distance to
#' give a single output location\cr --output would be a single destination location
#' \item a single start location with one or more bearings or distances
#' to give multiple output locations\cr --output would be a destination
#' locations for each combination of bearings and distances
#' \item multiple start locations with a single bearing or distance\cr
#' --output would be a destination locations representing the bearing
#' and distance from each of the start locations
#' \item multiple start locations with multiple bearings or distances
#' \cr --output would be a destination locations representing the
#' combinations of bearings and distances from each of the start
#' locations\cr
#' -- NOTE that the bearing and distance vectors must be of the same
#' length of the input lat and long.  }
#'
