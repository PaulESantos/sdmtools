...
#' @return returns single values representing the:
#' \item{ommission}{the ommission rate as a proportion of true occurrences misidentified given the defined threshold value}
